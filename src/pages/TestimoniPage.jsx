    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-100 py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold text-slate-900 mb-3">Testimoni Pelanggan</h1>
          <p className="text-slate-500">Cerita nyata dari penulis dan pelanggan yang telah mempercayai Media Fikra</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map(t => (
              <div key={t.id} className="bg-white rounded-2xl p-6 border border-slate-100 hover:shadow-md transition-shadow relative">
