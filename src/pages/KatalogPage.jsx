    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Katalog Buku</h1>
          <p className="text-slate-500">Temukan buku-buku berkualitas dari penulis terpilih Media Fikra</p>
